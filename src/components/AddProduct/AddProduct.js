...
<Form onSubmit={handleContactForm}>
    ...
    <Form.Group className="mb-3" controlId="formBasicPassword">
        ...
        <Form.Control type="text" name='price' placeholder="Product Price" required />
    </Form.Group>
    <Form.Group className="mb-3" controlId="formBasicPassword">
        <Form.Label>Product Stock</Form.Label>
        <Form.Control type="number" name='stock' placeholder="Product Stock" required />
    </Form.Group>
    <Form.Group className="mb-3" controlId="formBasicPassword">
        <Form.Label>Image URL</Form.Label>
        <Form.Control type="url" name='url' placeholder="Enter Image URL" required />
    </Form.Group>
    <Form.Group className="mb-3" controlId="formBasicPassword">
        <Form.Label>Description</Form.Label>
         <Form.Control as="textarea" name="description" rows={6} placeholder="Write Product Description.."/>
        </Form.Group>

    <div className="d-grid gap-2 mt-3">
        <Button variant="primary" size="lg" type="submit" >Add New Item</Button>
    </div>
</Form>
</div>
